...
class MutationUpdateAnnotationParser extends MutationAnnotationParser
{
    ...
    public function parse($annotation, \ReflectionClass $refClass, Endpoint $endpoint)
    {
        ...
        if (!$refClass->implementsInterface(NodeInterface::class)) {
            throw new \RuntimeException(sprintf('Can\'t apply Update operation to "%s", CRUD operations can only be applied to nodes. You are implementing "%s" in this class?', $refClass->getName(), NodeInterface::class));
        }
